...
if (e9Manager === undefined || e9Manager.init === false)
   ...
   e9Manager = (
	...
	e9Manager = manager;
        ...
        var e9Page = 
	 {
	   ...
	   tagOptions: {"allowPageUrlFromTags":true, "snackBar":{"serveSnackBar":false, "snackBarClose":false}, "isDebugActualTagSize":true, "adParams":{"inSingleAsyncFrame":true, "isDRMEnabled":true}, "allowTurnOffPageSafetyFromTags":true},
...
else
 {
   if (e9 !== undefined) 
    {
      e9Manager.setSite("googlebidder","papajohnsreach_set7");
